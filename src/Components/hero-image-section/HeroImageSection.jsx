...
const HeroImageSection = () => {
  return (
    <div className="relative w-full flex items-center justify-center">
      ...
      {/* Text Container */}
      <div className="absolute inset-0 flex flex-col justify-end items-center gap-2 sm:gap-3 md:gap-4 lg:gap-5 text-white text-center px-auto mb-4 md:mb-12 lg:mb-24 xl:mb-32">
