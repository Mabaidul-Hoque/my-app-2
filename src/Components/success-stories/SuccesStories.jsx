...
const SuccessStories = () => {
  ...
  return (
    <div className="relative w-full flex flex-col justify-center items-center px-2 sm:px-4 md:px-6 lg:px-20 py-5 sm:py-10 md:py-12 lg:py-16">
      <div className="flex flex-col justify-center items-center gap-2 sm:gap-3 md:gap-4 lg:gap-8 text-center mb-5 sm:mb-7 md:mb-8 lg:mb-10">
        <h2 className="font-bold text-3xl md:text-4xl lg:text-[52px]">
          Our Success Stories
        </h2>
